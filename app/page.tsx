...
function RoomScreen({ room, user, onLeave }) {
  ...
  return (
    <div className="h-screen bg-[#09090f]">
      ...
      >
        <div className="h-[58dvh] sm:h-[calc(100dvh-190px)] w-full overflow-hidden bg-[#09090f] p-2 sm:p-3
          [&_.lk-video-conference]:h-full [&_.lk-video-conference]:w-full [&_.lk-video-conference]:overflow-hidden
          [&_.lk-video-conference_.lk-control-bar]:hidden
          [&_.lk-grid-layout]:h-full [&_.lk-grid-layout]:w-full [&_.lk-grid-layout]:grid [&_.lk-grid-layout]:grid-cols-2 md:[&_.lk-grid-layout]:grid-cols-3 xl:[&_.lk-grid-layout]:grid-cols-4 [&_.lk-grid-layout]:auto-rows-fr [&_.lk-grid-layout]:gap-2
          [&_.lk-grid-layout>*]:min-h-0 [&_.lk-grid-layout>*]:h-full
